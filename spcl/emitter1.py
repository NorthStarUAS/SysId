# this is the first version of a type checker/resolver.  It seems to make some
# sense to integrate the code emitter into this flow, otherwise the type
# checking would need to be done again by the emitter and there is risk of
# divergence ... so this is saved as emitter1.py (just the type checking and I'm
# off to the races with emitter.py)
